"""
用大量合成資料 (synthetic_training_1000k) 預訓練 densenet201 模型。
...
class SynClassifier(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.classifier = nn.Linear(1920 * 2, cfg.num_class)
        self.criterion = nn.BCEWithLogitsLoss()

    def forward(self, images):
        x = self.backbone.features(images)  # (batch, channel=1920, height=2, width=58)
