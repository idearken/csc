"""
用大量合成資料 (synthetic_training_1000k) 預訓練 Inception-v3 模型。
...
class SynClassifier(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.classifier = nn.Linear(768 * 3, cfg.num_class)
        self.criterion = nn.BCEWithLogitsLoss()

    def forward(self, images):
        x = self.backbone(images)  # (batch, channel=768, height=3, width=58)
