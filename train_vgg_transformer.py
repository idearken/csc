"""
模型主架構：Pretrained VGG16 + Transformer
...
class cfg(object):
    ...
    pretrained_model = 'weights/vgg_synthetic_1000k.pt'  # 已事先用「合成序號」預訓練過的 backbone 權重
...
class CSCIdentifier(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.map_to_seq = torch.nn.Linear(512 * 2, cfg.d_model)
    ...
    def forward(self, images, targets):
        conv = self.backbone(images)  # (batch, channel=512, height=2, width=58)
